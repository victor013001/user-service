package com.pragma.challenge.user_service.domain.constants;
...
public class ConstantsMsg {
  ...
  public static final String SUCCESS_REGISTER_TO_BOOTCAMP_MSG =
      "The register to the bootcamp was successfully";
}
